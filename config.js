...
global.sig = '-'
global.sgh = 'https://github.com/yaqigaming' //github
...
global.APIKeys = { // APIKey Here
  ...
  'https://botstyle-api.herokuapp.com': '46aeb6a3-1bcd-499f-99d0-b213cd6e814d',
...
/*============== WATERMARK ==============*/
global.wm = '                「 MUSO-BOT 」' //Main Watermark
global.wm2 = '꒷︶꒷꒥꒷ ‧₊˚ ꒰ฅ˘MUSO-BOT ˘ฅ ꒱ ‧₊˚꒷︶꒷꒥꒷'
global.wm3 = '⫹⫺ MUSO-BOT '
global.botdate = `⫹⫺ DATE: ${week} ${date}\n⫹⫺ 𝗧𝗶𝗺𝗲: ${wktuwib}`
global.bottime = `T I M E : ${wktuwib}`
global.titlebot = `⫹⫺ WhatsApp Bot | By MUSO-BOT`
global.author = '                「 MUSO-BOT  あ」'
